...
+ (BOOL)openKakaoAppLinkWithMessage:(NSString *)message
    ...
    NSString *appDataString = [[NSDictionary dictionaryWithObject:metaInfoArray forKey:@"metainfo"] toJsonString];
...
+ (BOOL)openStoryLinkWithPost:(NSString *)post
	...
	if (urlInfoDict.count > 0) {
		[parameters setObject:[urlInfoDict toJsonString] forKey:@"urlinfo"];
	}
